...
export const projects: Project[] = [
  {
    ...
    github: "https://github.com/HaseebUllah312/studio3d",
    stats: {
      rendering: "Real-time",
      interaction: "360°",
      tech: "R3F"
  ...
  },
  {
    ...
    description: "Personal media command center—download files, convert stickers, and save social media content instantly.",
