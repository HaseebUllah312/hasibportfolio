...
const achievements = [
  {
    ...
    items: [
      ...
      "• React Three Fiber & 3D Web Development Mastery",
      ...
      <div className="grid gap-8 md:gap-12 lg:grid-cols-[280px_1fr]">
        ...
        >
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            Hello! I&apos;m Haseeb Ullah, a Software Engineer and Cyber Security Analyst. I specialize in developing secure digital solutions and professional CCTV surveillance installations, bridging the gap between digital code and physical security.
            </p>
            <p className="text-muted-foreground text-justify leading-relaxed">
              My journey in tech is driven by a foundation in software engineering and a deep expertise in networking and hardware. From configuring complex network infrastructures to installing enterprise-grade CCTV systems, I ensure that security is maintained at every level—both online and on-site. I have successfully earned professional certifications in Cyber Security, including the Cisco Certified Support Technician (CCST) Cybersecurity.
            </p>
            <p className="text-muted-foreground text-justify leading-relaxed">
              With experience in WordPress development, React Three Fiber, and advanced networking, I am building a well-rounded skill set that allows me to approach problems from both a developer's and a security professional's perspective.
            </p>
          </div>
